...
public static abstract class Stub extends android.os.Binder implements com.example.aidldemo.ICat
{
private static final java.lang.String DESCRIPTOR = "com.example.aidldemo.ICat";
...
/**
 * Cast an IBinder object into an com.example.aidldemo.ICat interface,
 * generating a proxy if needed.
 */
public static com.example.aidldemo.ICat asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.example.aidldemo.ICat))) {
return ((com.example.aidldemo.ICat)iin);
}
return new com.example.aidldemo.ICat.Stub.Proxy(obj);
}
...
private static class Proxy implements com.example.aidldemo.ICat
{
